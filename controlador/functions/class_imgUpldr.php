...
class imgUpldr {
    ...
    private $_width = 200; // Ancho máximo por defecto
    private $_height = 200; // Alto máximo por defecto
    private $_size = 500000; // Peso máximo. MAX_FILE_SIZE sobrescribe este valor

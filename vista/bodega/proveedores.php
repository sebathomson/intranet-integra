...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es-ES">
    ...
    <body>
        ...
        <div name="menu">
            <ul id="menu">
                <li id="lifirst"><a href="materiales.php"><img class="left" alt="Logo" src="../images/menu_left.png" width="206px" height="45px" /></a></li>
        ...
        <div id="contenedortop">
            ...
            <div name="titulo">
                <span id="titleseccion">BODEGA - PROVEEDORES</span>
            ...
            case "modificar":
                ...
                <div id="contenedor">
                    ...
                    <form method="POST" name="modificarproveedor" action="../../controlador/controlador_administracion_proveedores.php?accion=modificar">
                        ...
                        <input type="hidden" name="proveedor_vista" value="bodega" />
                    ...
                    <form name="crearproveedor" method="POST" action="../../controlador/controlador_administracion_proveedores.php?accion=crear">
                        ...
                        <table id="formularios">
                            <tbody>
                                <tr>
                                    <td>RUT:</td>
                                    <td><input type="text" name="proveedor_rut" size="12" maxlength="12" /><span class="valueEjemplo">12.345.678-9</span></td>
                                </tr>
                                <tr>
                                    <td>Nombre:</td>
